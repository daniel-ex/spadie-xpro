...
cprequire_test(["inline:com-chilipeppr-workspace-grbl-danielwk"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-grbl-danielwk", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-grbl-danielwk", // Make the id the same as the cpdefine id
        name: "Workspace / grbl", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace grbl for xpro.`,
